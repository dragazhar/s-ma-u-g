...
public class TrackTheTrail extends SearchProblem {
	...
	public TrackTheTrail(int n, String dataFileName, String name) throws IOException {
		super();
	...
	public double getPointScore(Point p) {
		...
		MeFST_S_CSR trailTrackerRepresentation = new MeFST_S_CSR(this.getN(), this.getK());
		...
		ant.createTrailTracker(trailTrackerRepresentation.decode(TrailTracker.events, TrailTracker.actions));
	...
	public void printSolution(Point p) throws IOException {
		...
		TrailTracker ant = new TrailTracker();
		ant.createTrailTracker(trailTrackerRepresentation.decode(ant.getInputAlphabet(), ant.getOutputAlphabet()));
